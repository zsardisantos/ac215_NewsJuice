    ...
    try:
        ...
        if os.path.exists(sa_key_path):
            ...
            client = storage.Client(
                credentials=credentials, project=os.environ.get("GOOGLE_CLOUD_PROJECT", "newsjuice-123456")
            )
        ...
        signed_url = blob.generate_signed_url(expiration=expiration, method="GET", credentials=credentials)
