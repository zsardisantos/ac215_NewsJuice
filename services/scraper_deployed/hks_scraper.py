...
class HksArticleScraper:
    ...
    def extract_article_links(self, soup):
        ...
        for a in soup.find_all("a"):
            href = a.get("href")
            if href and "/announcements/" in href:
    ...
    def extract_article_author(self, soup):
        ...
        return None  # all inspected articles dont have a clear author
    ...
    def scrape(self):
        ...
        with sync_playwright() as playwright:
            ...
            for url in article_urls:
                if "https://hks.harvard.edu" not in url:
                    normalized_urls.append("https://hks.harvard.edu" + url)
                else:
            ...
            for article_url in tqdm(list(article_urls)):
                ...
                article_details = {
                    ...
                    "source_type": "Harvard Kennedy School",
                    "summary": "",
                }
...
if __name__ == "__main__":
    scraper = HksArticleScraper(headless=False, test_mode="all_topics", wait_ms=1000)
